    ...
    <div class="row profile-body">
        ...
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-between mb-2">
            ...
            <div>
              <img class="wd-100 rounded-circle" src="{{ (!empty($profileData->photo)) ? url('images/admin/'.$profileData->photo) : url('images/no_image.jpg') }}" alt="profile">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.profile.store') }}" class="forms-sample" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <img id="showImage" class="wd-80 rounded-circle" src="{{ (!empty($profileData->photo)) ? url('images/admin/'.$profileData->photo) : url('images/no_image.jpg') }}" alt="profile">
                            </div>
